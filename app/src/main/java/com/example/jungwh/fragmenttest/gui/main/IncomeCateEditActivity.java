...
{
    private IncomeCateRetrieveTask authRetrieveTask;
    private IncomeCateRegisterTask authRegisterTask;
    private IncomeCateDeleteTask authDeleteTask;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewForm = findViewById(R.id.income_cate_edit_form);
        viewProgress = findViewById(R.id.income_cate_edit_layout);
    ...
    private void saveData(String data) {
        ...
        authRegisterTask = new IncomeCateRegisterTask(getApplicationContext() , userId, data);
    ...
    private void deleteData(String data){
        ...
        authDeleteTask = new IncomeCateDeleteTask(getApplicationContext() , userId, data);
    ...
    private class IncomeCateRegisterTask extends AsyncTask<Void, Void, Boolean> {
        private final Context context;
        private final String userId, data;
        CateRetrieveService cateRetrieveService = new CateRetrieveService();
        private String registerErrMsg;

        IncomeCateRegisterTask(Context context, String userId, String data) {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                return cateRetrieveService.register(userId, "001", data);
            } catch (JSONException | IOException e) {
    ...
    private class IncomeCateDeleteTask extends AsyncTask<Void, Void, Boolean> {
        private final Context context;
        private final String userId, data;
        CateRetrieveService cateRetrieveService = new CateRetrieveService();
